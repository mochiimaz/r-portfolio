    ...
    <section className="bg-[#FFF5E4] min-h-screen flex justify-center items-center p-6">
      ...
      */}
      <div className="flex flex-col md:flex-row items-center gap-12 max-w-5xl">
        ...
        */}
        <img
          className="w-full md:w-1/3 max-w-xs md:max-w-full rounded-lg shadow-lg"
        ...
        */}
        <div className="w-full md:w-2/3 text-center md:text-center">
          <h1 className="text-4xl sm:text-4xl font-bold mb-4 text-[#FF9494]">
            Hi, I'm <span className="text-black">Wimonrat Yongsungnern</span>
          </h1>
          ...
          <div className="flex justify-center md:justify-center space-x-4 text-lg font-bold">
            <Link
              to="/about"
              className="px-6 py-3 border-2 border-[#FF9494] text-[#FF9494] rounded-lg hover:bg-[#FFD1D1] hover:text-white transition duration-300"
            >
              See more about me
            </Link>
          </div>
